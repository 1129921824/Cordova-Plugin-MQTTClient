...
var mqtt={
    ...
    _connect: function(success, error){
        exec(success, error, "MQTTPlugin", "connect", [mqtt.host, mqtt.port, mqtt.options]);
    },
    ...
    _publish: function(id, topic, message, qos, retain, success, error){
        exec(success, error, "MQTTPlugin", "publish", [id, topic, message, qos, retain]);
    },
    ...
    onSubscribe: function(back){
        console.log("onSubscribe");
    },
    onSubscribeError: function(back){
